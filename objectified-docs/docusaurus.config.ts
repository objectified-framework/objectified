...
const config: Config = {
  ...
  url: 'https://docs.objectified.dev/',
  ...
  organizationName: 'objectified-framework', // Usually your GitHub org/user name.
  projectName: 'objectified', // Usually your repo name.
