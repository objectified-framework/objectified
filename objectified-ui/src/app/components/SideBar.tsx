      ...
      <>
        ...
        <div style={{
          ...
          <Stack direction={'column'}>
            ...
            <Item sx={{ padding: '0px', paddingTop: '5px', backgroundColor: '#060606', color: selectedColor('/generation') }}>
              <ListItemButton sx={{ paddingLeft: '10px', minHeight: 32, borderRadius: 2, border: '1px solid #060606',
                '&:hover': {
                  border: '1px solid #fff', backgroundColor: selectedBackgroundColor('/generation')
                }, backgroundColor: selectedBackgroundColor('/generation')
              }} onClick={() => router.push('/generation')}>
                <ListItemIcon sx={{ color: 'inherit', minWidth: '40px' }}><SaveAltOutlined/></ListItemIcon>
              </ListItemButton>
            </Item>
