...
--
--     -- Step 2: Insert or update the class_schema table.
...
-- $$ LANGUAGE plpgsql;
--
-- DROP TRIGGER IF EXISTS trg_update_class_schema ON obj.class_property;
--
-- CREATE TRIGGER trg_update_class_schema
--     AFTER INSERT OR UPDATE OR DELETE ON obj.class_property
--     FOR EACH ROW EXECUTE FUNCTION obj.update_class_schema();
