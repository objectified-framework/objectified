DROP FUNCTION IF EXISTS generate_schema_for_class;
DROP FUNCTION IF EXISTS obj.generate_schema_for_class;
...
SELECT jsonb_build_object(
               ...
               'properties', jsonb_object_agg(
                       ...
                       jsonb_strip_nulls(jsonb_build_object(
                               ...
                               'pattern', CASE
                                              WHEN f.pattern IS NOT NULL THEN f.pattern
                                              ELSE NULL
                                   END,
