...
(async () => {
  ...
  program
    ...
    .addOption(
      new Option("-g <generator>", "output generator to use").choices(
        GENERATORS,
      ),
    )
    .option(
    ...
    .option(
      ...
      "output directory for generated controllers",
    ...
    .option(
      "--utils <directory>",
      "output directory for generated utils",
      UTILS_DIRECTORY,
    )
